...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/home/john/miniconda3/lib/python3.7/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/home/john/miniconda3/lib/python3.7/site-packages/numpy/core/include/numpy/ufuncobject.h"
        ],
        "extra_compile_args": [
            "-fopenmp",
            "-march=native"
        ...
        "include_dirs": [
            "/home/john/miniconda3/lib/python3.7/site-packages/numpy/core/include"
        ],
        "name": "kalman",
        "sources": [
            "kalman_filter.pyx"
...
#define __PYX_HAVE__kalman
#define __PYX_HAVE_API__kalman
/* Early includes */
#include <string.h>
#include <stdio.h>
...
struct __pyx_opt_args_6kalman_kalman_filter;

/* "kalman_filter.pyx":10
...
/* Module declarations from 'kalman' */
...
static PyObject *__pyx_f_6kalman_kalman_filter(PyArrayObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6kalman_kalman_filter *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "kalman"
extern int __pyx_module_is_main_kalman;
int __pyx_module_is_main_kalman = 0;
...
static PyObject *__pyx_pf_6kalman_kalman_filter(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_z, Py_ssize_t __pyx_v_n_iter); /* proto */
...
static PyObject *__pyx_pw_6kalman_1kalman_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_6kalman_kalman_filter(PyArrayObject *__pyx_v_z, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6kalman_kalman_filter *__pyx_optional_args) {
  Py_ssize_t __pyx_v_n_iter = ((Py_ssize_t)10);
  Py_ssize_t __pyx_v_sz;
  double __pyx_v_Q;
  PyObject *__pyx_v_temp = NULL;
  __Pyx_memviewslice __pyx_v_xhat = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_P = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_xhatminus = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_Pminus = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_K = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_R;
  Py_ssize_t __pyx_v_k;
  CYTHON_UNUSED Py_ssize_t __pyx_v_n_it;
  ...
  __Pyx_RefNannySetupContext("kalman_filter", 0);
  ...
  __pyx_pybuffernd_z.rcbuffer = &__pyx_pybuffer_z;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_z.rcbuffer->pybuffer, (PyObject*)__pyx_v_z, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
 ...
 */
  __pyx_v_sz = (__pyx_v_z->dimensions[0]);

  /* "kalman_filter.pyx":20
 * #   DTYPE =
 *     cdef Py_ssize_t sz = z.shape[0]
 *     Q = 1e-5 # process variance             # <<<<<<<<<<<<<<
 *     temp = np.zeros(sz, dtype=np.float32)
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_sz); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_v_temp, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 23, __pyx_L1_error)
  __pyx_v_xhat = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "kalman_filter.pyx":24
 *     # allocate space for arrays
 *     cdef float[:] xhat = temp                                    # a posteri estimate of x
 *     cdef float[:] P = np.zeros(sz, dtype=np.float32)           # a posteri error estimate             # <<<<<<<<<<<<<<
 *     cdef float[:] xhatminus = np.zeros(sz, dtype=np.float32)   # a priori estimate of x
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_sz); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_P = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "kalman_filter.pyx":25
 *     cdef float[:] xhat = temp                                    # a posteri estimate of x
 *     cdef float[:] P = np.zeros(sz, dtype=np.float32)           # a posteri error estimate
 *     cdef float[:] xhatminus = np.zeros(sz, dtype=np.float32)   # a priori estimate of x             # <<<<<<<<<<<<<<
 *     cdef float[:] Pminus = np.zeros(sz, dtype=np.float32)      # a priori error estimate
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_sz); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_xhatminus = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "kalman_filter.pyx":26
 *     cdef float[:] P = np.zeros(sz, dtype=np.float32)           # a posteri error estimate
 *     cdef float[:] xhatminus = np.zeros(sz, dtype=np.float32)   # a priori estimate of x
 *     cdef float[:] Pminus = np.zeros(sz, dtype=np.float32)      # a priori error estimate             # <<<<<<<<<<<<<<
 *     cdef float[:] K = np.zeros(sz, dtype=np.float32)           # gain or blending factor
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_sz); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_float32); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_Pminus = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "kalman_filter.pyx":27
 *     cdef float[:] xhatminus = np.zeros(sz, dtype=np.float32)   # a priori estimate of x
 *     cdef float[:] Pminus = np.zeros(sz, dtype=np.float32)      # a priori error estimate
 *     cdef float[:] K = np.zeros(sz, dtype=np.float32)           # gain or blending factor             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_sz); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_K = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "kalman_filter.pyx":29
 *     cdef float[:] K = np.zeros(sz, dtype=np.float32)           # gain or blending factor
 * 
 *     R = 0.01**2  # estimate of measurement variance, change to see effect             # <<<<<<<<<<<<<<
 * 
 *     # intial guesses
 */
  __pyx_v_R = pow(0.01, 2.0);

  /* "kalman_filter.pyx":32
 * 
 *     # intial guesses
 *     xhat[0] = 0.0             # <<<<<<<<<<<<<<
 *     P[0] = 2.0
 ...
 */
  __pyx_t_7 = 0;
  *((float *) ( /* dim=0 */ (__pyx_v_xhat.data + __pyx_t_7 * __pyx_v_xhat.strides[0]) )) = 0.0;

  /* "kalman_filter.pyx":33
 *     # intial guesses
 *     xhat[0] = 0.0
 *     P[0] = 2.0             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t k, n_it = n_iter
 ...
 */
  __pyx_t_8 = 0;
  *((float *) ( /* dim=0 */ (__pyx_v_P.data + __pyx_t_8 * __pyx_v_P.strides[0]) )) = 2.0;

  /* "kalman_filter.pyx":34
 *     xhat[0] = 0.0
 *     P[0] = 2.0
 *     cdef Py_ssize_t k, n_it = n_iter             # <<<<<<<<<<<<<<
 *     for k in prange(1, n_it, nogil=True):
 *         # time update
 */
  __pyx_v_n_it = __pyx_v_n_iter;

  /* "kalman_filter.pyx":35
 *     P[0] = 2.0
 *     cdef Py_ssize_t k, n_it = n_iter
 *     for k in prange(1, n_it, nogil=True):             # <<<<<<<<<<<<<<
 *         # time update
            ...
            if (__pyx_t_11 > 0)
            {
                ...
                #endif /* _OPENMP */
                {
                    ...
                    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_11; __pyx_t_10++){
                        ...
                        {
                            __pyx_v_k = (Py_ssize_t)(1 + 1 * __pyx_t_10);

                            /* "kalman_filter.pyx":37
 *     for k in prange(1, n_it, nogil=True):
 *         # time update
 *         xhatminus[k] = xhat[k-1]             # <<<<<<<<<<<<<<
 *         Pminus[k] = P[k-1]+Q
 ...
 */
                            ...
                            *((float *) ( /* dim=0 */ (__pyx_v_xhatminus.data + __pyx_t_13 * __pyx_v_xhatminus.strides[0]) )) = (*((float *) ( /* dim=0 */ (__pyx_v_xhat.data + __pyx_t_12 * __pyx_v_xhat.strides[0]) )));

                            /* "kalman_filter.pyx":38
 *         # time update
 *         xhatminus[k] = xhat[k-1]
 *         Pminus[k] = P[k-1]+Q             # <<<<<<<<<<<<<<
 * 
 ...
 */
                            ...
                            *((float *) ( /* dim=0 */ (__pyx_v_Pminus.data + __pyx_t_15 * __pyx_v_Pminus.strides[0]) )) = ((*((float *) ( /* dim=0 */ (__pyx_v_P.data + __pyx_t_14 * __pyx_v_P.strides[0]) ))) + __pyx_v_Q);

                            /* "kalman_filter.pyx":41
 * 
 *         # measurement update
 ...
 */
                            ...
                            __pyx_t_17 = (*((float *) ( /* dim=0 */ (__pyx_v_Pminus.data + __pyx_t_16 * __pyx_v_Pminus.strides[0]) )));
                            __pyx_t_18 = __pyx_v_k;
                            __pyx_t_19 = ((*((float *) ( /* dim=0 */ (__pyx_v_Pminus.data + __pyx_t_18 * __pyx_v_Pminus.strides[0]) ))) + __pyx_v_R);
                            ...
                            *((float *) ( /* dim=0 */ (__pyx_v_K.data + __pyx_t_20 * __pyx_v_K.strides[0]) )) = (__pyx_t_17 / __pyx_t_19);

                            /* "kalman_filter.pyx":42
 *         # measurement update
 *         K[k] = Pminus[k] / ( Pminus[k] + R )
 *         xhat[k] = xhatminus[k] + K[k] * ( z[k] - xhatminus[k] )             # <<<<<<<<<<<<<<
 *         P[k] = ( 1 - K[k] ) * Pminus[k]
 ...
 */
                            ...
                            *((float *) ( /* dim=0 */ (__pyx_v_xhat.data + __pyx_t_25 * __pyx_v_xhat.strides[0]) )) = ((*((float *) ( /* dim=0 */ (__pyx_v_xhatminus.data + __pyx_t_21 * __pyx_v_xhatminus.strides[0]) ))) + ((*((float *) ( /* dim=0 */ (__pyx_v_K.data + __pyx_t_22 * __pyx_v_K.strides[0]) ))) * ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_z.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_z.diminfo[0].strides)) - (*((float *) ( /* dim=0 */ (__pyx_v_xhatminus.data + __pyx_t_24 * __pyx_v_xhatminus.strides[0]) ))))));

                            /* "kalman_filter.pyx":43
 *         K[k] = Pminus[k] / ( Pminus[k] + R )
 *         xhat[k] = xhatminus[k] + K[k] * ( z[k] - xhatminus[k] )
 *         P[k] = ( 1 - K[k] ) * Pminus[k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                            ...
                            *((float *) ( /* dim=0 */ (__pyx_v_P.data + __pyx_t_28 * __pyx_v_P.strides[0]) )) = ((1.0 - (*((float *) ( /* dim=0 */ (__pyx_v_K.data + __pyx_t_26 * __pyx_v_K.strides[0]) )))) * (*((float *) ( /* dim=0 */ (__pyx_v_Pminus.data + __pyx_t_27 * __pyx_v_Pminus.strides[0]) ))));
                            goto __pyx_L11;
                            __pyx_L8_error:;
                            {
                                #ifdef WITH_THREAD
 ...
 */
  ...
  __Pyx_AddTraceback("kalman.kalman_filter", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_z.rcbuffer->pybuffer);
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_xhat, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_P, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_xhatminus, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_Pminus, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_6kalman_1kalman_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6kalman_kalman_filter[] = "\n    Variables\n    ===\n    array of the input np.ndarray[np.float32_t, ndim=1] \n    n_iter = number of iterations (default 10)\n    \n    ";
static PyObject *__pyx_pw_6kalman_1kalman_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_z = 0;
  Py_ssize_t __pyx_v_n_iter;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("kalman_filter (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_z,&__pyx_n_s_n_iter,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "kalman_filter") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    } else {
    ...
    if (values[1]) {
      __pyx_v_n_iter = __Pyx_PyIndex_AsSsize_t(values[1]); if (unlikely((__pyx_v_n_iter == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    } else {
      __pyx_v_n_iter = ((Py_ssize_t)10);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("kalman_filter", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("kalman.kalman_filter", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_z), __pyx_ptype_5numpy_ndarray, 1, "z", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_r = __pyx_pf_6kalman_kalman_filter(__pyx_self, __pyx_v_z, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_6kalman_kalman_filter(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_z, Py_ssize_t __pyx_v_n_iter) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_z;
  __Pyx_Buffer __pyx_pybuffer_z;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_6kalman_kalman_filter __pyx_t_2;
  __Pyx_RefNannySetupContext("kalman_filter", 0);
  __pyx_pybuffer_z.pybuffer.buf = NULL;
  __pyx_pybuffer_z.refcount = 0;
  __pyx_pybuffernd_z.data = NULL;
  ...
  __pyx_t_1 = __pyx_f_6kalman_kalman_filter(__pyx_v_z, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "kalman._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"kalman_filter", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6kalman_1kalman_filter, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6kalman_kalman_filter},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_kalman(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_kalman},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initkalman(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initkalman(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_kalman(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_kalman(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_kalman(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'kalman' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_kalman(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("kalman", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_kalman) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "kalman")) {
      if (unlikely(PyDict_SetItemString(modules, "kalman", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kalman", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init kalman");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
